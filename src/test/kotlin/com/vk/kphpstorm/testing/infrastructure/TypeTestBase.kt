...
abstract class TypeTestBase : KphpStormTestBase() {
    ...
    private fun checkExprTypeCall(call: FunctionReference) {
        ...
        val expr = call.parameters.first() as? PhpTypedElement ?: return
        val expectedTypePsi = call.parameters.last() as? StringLiteralExpression ?: return
        val expectedTypeString = expectedTypePsi.contents
        val gotType = expr.type.global(myFixture.project).toExPhpType()
