...
namespace KphpPrimitives;

class S {
  function __toString(): string { return "S"; }
}
...
function myCallUser($u) {
  // Тут было без явного списка, но без него плагин не сможет вывести типы
  myVarDump/*<T>*/($u->isOlder($u));
}
