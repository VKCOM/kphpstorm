...
object KphpReturnDocTag : KphpDocTag("@kphp-return") {
    override val description: String
        get() = "Can be used if @kphp-template was specified, to provide information of returning class/fields based on template argument."
    ...
    override fun annotate(docTag: PhpDocTag, rhs: PsiElement?, holder: AnnotationHolder) {
        if (rhs == null)
            holder.errTag(docTag, "Specify returning class/fields based on template argument.")
    }
}
